...
import RootStackParamList, { ClientsUbication, HomeUbication, RootMain } from '../../../../TypeDefinitios/DefinitiosNavigateMain';
...
import { ClienteLocation } from './ClientLocation';
...
export const ClientIndex = (): JSX.Element => {
  type ProfileScreenHomeNavigation = NativeStackNavigationProp<
    ...
    'Ventas'
  >;
  const Root = createStackNavigator<ClientsUbication>();
  const navigation = useNavigation<ProfileScreenHomeNavigation>();

  return (
    <Root.Navigator
      screenOptions={{ headerShown: false}}>
      <Root.Screen name="Ventas" component={Ventas} />
