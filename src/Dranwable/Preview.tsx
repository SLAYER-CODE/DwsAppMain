...
function Preview() {
    ...
    const stylespwd = StyleSheet.create({
        container: {
            ...
            width: 500,
            height: 500, position: 'absolute', borderWidth: 20, zIndex: 1000
        },
        view: {
            flex: 1,
            backgroundColor: 'red',
    ...
    const [scale, setscale] = React.useState<Animated.Value>(new Animated.Value(-1))
    ...
    return (
        <>
            <SafeAreaView style={[styles.containerAbsolute, { backgroundColor: '#004B63' }]}>
                ...
                <View style={{ justifyContent: 'center', alignItems: 'center', width: 100, height: 100, bottom: 50, borderRadius: 50, right: 50, borderWidth: 5, position: 'absolute', zIndex: 10 }}>
                    <AxisPad
                ...
                <View style={{ position: 'absolute', bottom: 50, left: 20, width: 100, height: 30, zIndex: 5 }}>
                    <Text style={{ top: -20, fontWeight: 'bold', fontSize: 20 }}>Controles</Text>
                    <View style={{ flex: 1, justifyContent: 'center', flexDirection: 'column', flexWrap: 'wrap' }}>
                        <TouchableHighlight activeOpacity={0.6}
                            underlayColor="#FFFFFF33" style={{ height: 45, width: 45, alignItems: 'center', }} onPress={() => {
                                rotateZ.setValue((rotateZ as any).__getValue() - 15.5);
                            }}>
                            <View style={{ borderRadius: 10, borderWidth: 1, backgroundColor: '#000000', width: 50, justifyContent: 'center', alignItems: 'center' }}>
                                <Text><Icon name="caretleft" size={40} color='orange' /> </Text>
                        ...
                        <TouchableHighlight activeOpacity={0.6}
                            ...
                            <View style={{ borderRadius: 10, borderWidth: 1, backgroundColor: '#000000', width: 50, justifyContent: 'center', alignItems: 'center' }}>
                                <Text><Icon name="caretright" size={40} color='orange' /> </Text>
                        ...
                        <TouchableHighlight activeOpacity={0.6}
                            ...
                            <View style={{ borderRadius: 10, borderWidth: 1, backgroundColor: '#000000', width: 50, justifyContent: 'center', alignItems: 'center' }}>
                                <Text><Icon name="caretdown" size={40} color='orange' /> </Text>
                        ...
                        <TouchableHighlight activeOpacity={0.6}
                            ...
                            <View style={{ borderRadius: 10, borderWidth: 1, backgroundColor: '#000000', width: 50, justifyContent: 'center', alignItems: 'center' }}>
                                <Text><Icon name="caretup" size={40} color='orange' /> </Text>
